...
export default function createRoutes(AuthController, PostController, UserRepository) {
  console.log('OBJETO PostController QUE AS ROTAS RECEBERAM:', PostController);
  const routes = Router();
  ...
  // ALTERAÇÃO AQUI: Removemos o 'AuthController.login' daqui, pois ele já é chamado dentro do 'createUser'.
